...
# Тело цикла:
# 	7.1 Выводить в консоль (“Step_1 =”, count)
...
# 8 Сделать if с условием, если count равен 3 то выводить в консоль(“Step =”, count, ‘If  body’)

    if count == 3:
        print('Step_1 = ', count, 'If body')
        print('-----------')

# 9 Сделать цикл while который будет работать пока run Тело цикла:
#         9.1 Выводить в онсоль(“Step =”, count)
...
#         9.4 Втеле if вывестивконсоль(“STOP”, count)
